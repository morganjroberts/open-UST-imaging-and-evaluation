...
%     step to prepare for the FFTs during backpropagation. Finally, the
%     time series are filtered to remove high frequency content not
%     supported by the spatial grid step size. To save the data, the input
%     data file is copied, and the pressure, time_axis, and Nt variables
%     are overwritten with their post-processed versions. All other
